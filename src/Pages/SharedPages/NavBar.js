...
const NavBar = () => {
    ...
    <React.Fragment>
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ...
              : "font-bold text-lg tracking-wide text-accent dark:text-base-100 transition-colors duration-300 hover:text-primary dark:hover:text-info"
          }
        >
          Home
        </NavLink>
      ...
      <li>
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "px-5 py-2 btn text-base font-bold tracking-wide text-base-100 bg-primary border-transparent hover:text-base-100 hover:bg-primary hover:border-transparent"
              : "px-5 py-2 btn text-base font-bold tracking-wide text-primary dark:text-info bg-transparent border-2 border-primary dark:border-info transition-all duration-300 hover:text-base-100 hover:bg-primary hover:border-transparent dark:hover:bg-primary dark:hover:border-transparent dark:hover:text-base-100"
          }
        >
          Login
        </NavLink>
  ...
  return (
    <div className="dark:bg-gray-900 shadow">
      <div className="px-4 md:px-24 lg:px-8 py-5 mx-auto md:max-w-full lg:max-w-screen-2xl">
        <div className="relative flex items-center justify-between">
          ...
          <div className="lg:hidden">
            ...
            >
              <svg className="w-5 text-gray-600 dark:text-base-100" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
